...
void notEmptyFunction() {
  ...
  auto longLineLambda =
      [](int a, int b, int casfdasfasdfhasdkjfhaskdjfhkasdhfkashdfjkhaskfjhas) {
        print(a);
      };
  longLineLambda();
}
...
int veryLongFunction(int anotherArgument, int beforeCallMe,
...
int main() {
  ...
  dialog->addButton(i18n::tr("$OkId"), "common/green_frame.9.png",
...
EmptyStruct emptyStruct =
    EmptyStruct{}; // 1 space after ';'' otherwise: ;//1 space after...
